...
export default function AthleteDashboard() {
  ...
  return (
    <div className="space-y-8">
      {/* Header */}
      <div>
        <p className="text-gray-500 dark:text-gray-400 text-sm capitalize">{today}</p>
      ...
      <div className="card bg-gradient-to-br from-orange-500/20 to-orange-600/5 border-orange-500/20">
        <div className="flex items-center gap-4">
          ...
          <div>
            <p className="text-3xl font-black text-gray-900 dark:text-white">0 <span className="text-lg font-semibold text-orange-400">μέρες</span></p>
      ...
      <div className="card">
        <div className="flex items-center justify-between mb-4">
          ...
          <span className="text-xs bg-gray-100 dark:bg-gray-800 text-gray-500 dark:text-gray-400 px-2.5 py-1 rounded-full">Δευτέρα</span>
        </div>
        ...
        <div className="flex flex-col items-center justify-center py-10 text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400 font-medium">Δεν έχεις ανατεθεί πρόγραμμα</p>
          <p className="text-gray-400 dark:text-gray-500 text-sm mt-1">Ο trainer σου δεν έχει ανατείλει workout ακόμα</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="card">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">Βελτίωση</p>
        </div>
      </div>
    </div>
  );
