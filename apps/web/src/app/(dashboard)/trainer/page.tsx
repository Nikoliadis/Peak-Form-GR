  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-gray-400 mt-1">Εδώ είναι η επισκόπηση των athletes σου.</p>
      </div>
      ...
      <div className="card">
        <div className="flex items-center justify-between mb-6">
          ...
          <a href="/trainer/athletes" className="text-brand-400 text-sm hover:text-brand-300">
            Δες όλους →
          </a>
        </div>
        <div className="flex flex-col items-center justify-center py-12 text-center">
          ...
          <p className="text-gray-500 text-sm mt-1">Πρόσθεσε τον πρώτο athlete σου για να ξεκινήσεις</p>
      ...
      {/* Recent Activity */}
      <div className="card">
        <h2 className="text-lg font-semibold text-white mb-6">Πρόσφατη Δραστηριότητα</h2>
        <div className="flex flex-col items-center justify-center py-8 text-center">
          <Activity size={28} className="text-gray-600 mb-3" />
          <p className="text-gray-400 text-sm">Καμία δραστηριότητα ακόμα</p>
        </div>
      </div>
    </div>
  );
